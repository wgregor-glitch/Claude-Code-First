...
- "crash" — use ONLY when road traffic collision indicators are present in the scene: recently occurring visible vehicle damage, deployed airbags, overturned vehicle, a civilian vehicle stationary on unpaved grass or verge having clearly left the roadway, ambulance(s) stopped near a civilian vehicle or stretchers visible beside a car. A police vehicle with lights on driving or stopped at an intersection, patrolling, or near a median is NOT a crash. A vehicle near grass at an intersection or turning lane is NOT a crash.
