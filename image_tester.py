...
QUESTIONS["annotate"] = {
    "prompt": (
        ...
        "Step 2 (only if you are confident): Count each vehicle type visible.\n"
        "  - Singular = exactly 1 body clearly visible. Plural = 2+ bodies distinctly visible.\n"
        ...
        "  - 'No emergency vehicles' = you are certain no emergency vehicles are present anywhere in the frame.\n"
