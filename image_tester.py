...
QUESTIONS["annotate"] = {
    "prompt": (
        ...
        "Step 1: Can you clearly identify the vehicle type from its markings, shape, or colors?\n"
        "  \u2022 If YES and you are confident \u2192 select the specific type(s) and count below.\n"
        "  \u2022 If NO \u2014 because flashing lights wash out the scene, the image is dark or blurry, "
        "distance makes markings unreadable, or you can see lights but cannot confirm whether it is an "
        "emergency vehicle or a regular car \u2014 select HARD TO TELL and stop. Do not guess.\n\n"
        "Hard to tell applies broadly: any time you are not confident about vehicle type, "
        "not just severe image quality failure. When in doubt, choose hard to tell.\n\n"
        "If you can confidently identify vehicles, count each type:\n"
        ...
        "- 'No emergency vehicles' = you are confident none are present.\n"
        "- 'Hard to tell' and 'No emergency vehicles' are mutually exclusive and override all vehicle "
        "type selections.\n\n"
        "\u2550\u2550\u2550 PART 2 \u2014 INCIDENT TYPE \u2550\u2550\u2550\n\n"
        "Work through this numbered checklist in order. Apply every label that clearly matches.\n\n"
        "1. CRASH \u2014 select ONLY if you can see physical collision evidence: crumpled or damaged "
        "vehicle bodywork, deployed airbags, vehicles resting at abnormal angles (across lanes, in a "
        "ditch), or impact debris on the road surface. Emergency vehicles at the scene are NOT "
        "evidence of a crash. No visible damage = do not select crash.\n\n"
        "2. PULLED OVER \u2014 select ONLY if ALL three conditions are true: (a) a civilian vehicle "
        "is stopped on the road shoulder, off the travel lanes; (b) a police vehicle is stopped "
        "directly behind or beside it; (c) both are stationary. A police car at an intersection, in "
        "a travel lane, or driving alongside traffic is NOT a traffic stop.\n\n"
        "3. BLOCKED ROAD \u2014 select ONLY if a travel lane is completely closed with clear physical "
        "evidence: cones or barriers spanning the full width of a lane, or an emergency vehicle "
        "parked across a lane. One cone at the roadside is NOT a blocked road. Traffic slowing but "
        "still passing is NOT a blocked road.\n\n"
        "4. CONSTRUCTION \u2014 select ONLY if active road construction is visible: heavy yellow or "
        "orange construction machinery (excavators, pavers, rollers), or road workers in hi-vis vests "
        "actively working on the road surface. Cones or barriers alone are NOT construction. A police "
        "or fire presence with cones is incident response, NOT construction.\n\n"
        "5. FIRE \u2014 select if flames or heavy smoke are visible.\n\n"
        "6. CROWD \u2014 select if a group of civilians (not uniformed responders) is visibly "
        "gathered at the scene.\n\n"
        "7. IDENTIFIABLE INCIDENT, NOT ONE OF THE ABOVE \u2014 select when an emergency vehicle "
        "with active lights is clearly present but none of 1\u20136 can be confirmed. Use this for "
        "active but ambiguous scenes.\n\n"
        "8. NO INCIDENT CLEARLY VISIBLE \u2014 select when no emergency vehicles are present, or "
        "vehicles have no lights on, or the scene shows only normal traffic flow. This is the correct "
        "answer for routine camera views with no active incident.\n\n"
        "1\u20136 can be combined. 7 and 8 are exclusive with each other and with 1\u20136."
    ),
    "tool": {
        "type": "function",
        "function": {
