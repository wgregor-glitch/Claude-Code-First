...
QUESTIONS["annotate"] = {
    "prompt": (
        ...
        "3. BLOCKED ROAD \u2014 select ONLY if a travel lane is completely impassable due to clear "
        "physical obstruction:\n"
        "   \u2022 Multiple cones or solid barriers spanning the FULL width of a lane (shoulder cones "
        "alone do not count)\n"
        "   \u2022 An emergency vehicle or crash debris physically positioned ACROSS a lane so no "
        "traffic can pass\n"
        "   The road must be IMPASSABLE \u2014 not just slow or congested. If cars are actively "
        "flowing through any gap, do NOT select. A police car or fire truck stopped on the shoulder "
        "is NOT a blocked road. A single cone or partial shoulder closure is NOT a blocked road.\n\n"
        "4. CONSTRUCTION \u2014 select ONLY if you can see active road construction: large yellow or "
        "orange construction machinery operating on the road surface (excavators, pavers, graders), "
        "or road workers in hi-vis vests actively working on the pavement. Cones, barriers, or lane "
        "closures alone without machinery or workers are NOT construction. Emergency vehicles with "
        "cones at an incident scene are NOT construction.\n\n"
        ...
        "7. IDENTIFIABLE INCIDENT, NOT ONE OF THE ABOVE \u2014 select when BOTH are true:\n"
        "   (a) one or more emergency vehicles with active flashing lights are clearly visible and "
        "responding to something;\n"
        "   (b) NONE of items 1\u20136 above apply.\n"
        "   This is the correct label for active emergency response when the specific incident type "
        "cannot be determined. Do NOT select this if any of 1\u20136 apply. "
        "Do NOT select 8 if emergency vehicles are actively responding.\n\n"
        "8. NO INCIDENT CLEARLY VISIBLE \u2014 select when the scene shows normal traffic flow or "
        "empty road with no active emergency response. Select this if no emergency vehicles are "
        "present, or if vehicles present have no flashing lights and show no signs of active "
        "response. Do NOT select if emergency vehicles are actively responding.\n\n"
