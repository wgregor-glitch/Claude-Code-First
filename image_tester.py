...
QUESTIONS["annotate"] = {
    "prompt": (
        ...
        "- Use 'Hard to tell' when the image quality itself prevents confident identification: severe "
        "overexposure or glare washing out the scene, extreme darkness, or heavy blur — where you cannot "
        "reliably distinguish an emergency vehicle from a regular car. Do NOT use it simply because you "
        "are unsure of the count; count uncertainty defaults to singular instead.\n"
        ...
        "Read the definitions carefully before selecting:\n\n"
        "- Crash: there is visible evidence of a vehicle collision — look for damaged or crumpled vehicles, "
        "deployed airbags, vehicles at abnormal angles across lanes or off the road, or debris from an "
        "impact. Emergency vehicles alone at the scene are NOT evidence of a crash; you need to see the "
        "collision damage itself. A fire truck with road cones does not confirm a crash unless damaged "
        "vehicles are also visible.\n"
        "- Construction: look for yellow/orange construction equipment (excavators, bulldozers, road "
        "pavers), workers in high-visibility vests, construction signage, or fresh lane markings. "
        "A fire truck or police car with cones is a crash/incident response — NOT construction.\n"
        "- Pulled over vehicle: a civilian vehicle is stationary on the road shoulder with a police vehicle "
        "stopped directly behind or alongside it — both must be parked/stopped. A police car at an "
        "intersection, in moving traffic, or near a civilian car that is not on the shoulder does NOT "
        "count as a traffic stop.\n"
        "- Blocked road: a travel lane is physically obstructed so through-traffic cannot pass — requires "
        "explicit evidence: cones or barriers spanning a travel lane, crash debris in the road, or an "
        "emergency vehicle stopped across a lane. A police car or fire truck on the shoulder with traffic "
        "still flowing past is NOT a blocked road.\n"
        "- Crowd: a visible group of people gathered — pedestrians, bystanders, or responders on foot "
        "congregating at the scene. Uniformed responders working at a scene do not count as a crowd.\n"
        "- Identifiable incident, not one of the above: use this as your DEFAULT when you can clearly see "
        "an emergency vehicle with lights activated but the specific incident type (crash, pull-over, "
        "blocked road, construction, fire, crowd) cannot be confirmed from the image. This includes: "
        "police at an intersection with lights on and no other visible context; multiple emergency vehicles "
        "present but no collision damage visible; glare or brightness obscuring the scene behind the "
        "lights. IMPORTANT — never select 'No incident clearly visible' when an emergency vehicle with "
        "lights on is present; use this category instead.\n"
        "- No incident clearly visible: use ONLY when there are no emergency vehicles present, or the "
        "vehicles present have no lights on and there is no other sign of activity.\n\n"
        "  ☑ Crash\n"
        "  ☑ Pulled over vehicle\n"
        "  ☑ Blocked road\n"
        "  ☑ Construction\n"
